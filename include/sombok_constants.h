...
#define LB_ZJ ((propval_t)33)
#define LB_SG ((propval_t)34)
#define LB_AI ((propval_t)35)
#define LB_SA ((propval_t)36)
#define LB_XX ((propval_t)37)
#define LB_HL ((propval_t)38)
...
#define GB_NonJoiner ((propval_t)14)
#define GB_Joiner ((propval_t)15)
#define GB_After_Joiner ((propval_t)16)
